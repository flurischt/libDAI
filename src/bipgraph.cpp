    ...
    if( nrNodes1() == 0 )
        ...
        do {
            ...
            if( levels.size() == 0 ) {
                ...
                // build newLevel.ind1
                for( size_t n2 : prevLevel.ind2 ) { // for all n2 in the previous level
                    for( const Neighbor &n1 : nb2(n2) ) { // for all neighbors n1 of n2
                ...
                // build newLevel.ind2
                for( size_t n1 : newLevel.ind1 ) { // for all n1 in this level
                    for( const Neighbor &n2 : nb1(n1) ) { // for all neighbors n2 of n1
