 ...
 */
    ...
    public:
        ...
        /// Default constructor
        BP()
                : DAIAlgFG(), _edges(), _indices(), _oldProd(), _lut(), _maxdiff(0.0), _iters(0U), _sentMessages(),
                  _oldBeliefsV(), _oldBeliefsF(), _updateSeq(), props(), recordSentMessages(false) { }

        /// Construct from FactorGraph \a fg and PropertySet \a opts
        /** \param fg Factor graph.
         *  \param opts Parameters @see Properties
         */
        BP(const FactorGraph &fg, const PropertySet &opts) : DAIAlgFG(fg), _edges(), _indices(), _oldProd(),
                                                             _maxdiff(0.0), _iters(0U), _sentMessages(), _oldBeliefsV(),
                                                             _oldBeliefsF(), _updateSeq(), props(),
        ...
        /// Copy constructor
        BP(const BP &x) : DAIAlgFG(x), _edges(x._edges), _indices(x._indices), _oldProd(x._oldProd), _lut(x._lut),
                          _maxdiff(x._maxdiff), _iters(x._iters), _sentMessages(x._sentMessages),
                          _oldBeliefsV(x._oldBeliefsV), _oldBeliefsF(x._oldBeliefsF), _updateSeq(x._updateSeq),
