...
class BP : public DAIAlgFG {
    ...
    protected:
        ...
        void calcIncomingMessageProduct_0101_0011(__m256d& prod, size_t I, size_t i) const;

        void marginalizeProductOntoMessage(__m256d& prod, size_t i, size_t _I, size_t prodsize);
